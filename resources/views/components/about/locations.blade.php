...
[
'name' => 'Center Makassar',
'region' => 'Sulawesi Selatan',
'status' => null,
'address' => 'Jl. Pettarani No. 102, Makassar',
'lat' => -5.156015,
'lng' => 119.433611,
'active' => true,
],
                            ...
                            <div class="ml-4 mt-2 flex items-center justify-between">
                                <span class="flex items-center gap-1 text-xs font-medium text-amber-500">
                                    <svg class="h-3.5 w-3.5 fill-amber-400" viewBox="0 0 24 24">
                                        <path d="M12 2.5l2.9 6 6.6.6-5 4.4 1.5 6.5-6-3.6-6 3.6L7.5 13.5l-5-4.4 6.6-.6L12 2.5Z" />
                                    </svg>
                                    {{ $loc['rating'] }}
                                </span>
                    ...
                    <div class="mt-4 border-t border-slate-100 pt-4">
                        ...
                        <div class="mt-2 grid grid-cols-2 gap-x-3 gap-y-1.5">
                            ...
                            <span class="flex items-center gap-1.5 text-xs text-slate-600">
                                <svg class="h-3.5 w-3.5 text-blue-500" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    (function() {
        ...
        const markers = locations.map((loc, i) => {
            const marker = L.marker([loc.lat, loc.lng], {
                icon: makeIcon(i + 1, loc.active)
            }).addTo(map);

            const popup = L.popup({
                maxWidth: 260,
                className: 'bank-popup'
            }).setContent(`
