    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
            ...
            <div class="hidden md:flex items-center gap-8 mx-auto">
                <a href="#" class="text-sm font-medium text-gray-700 hover:text-blue-600 transition">Fitur</a>
                <a href="#" class="text-sm font-medium text-gray-700 hover:text-blue-600 transition">Tabungan &amp; Bunga</a>
                <a href="#" class="text-sm font-medium text-gray-700 hover:text-blue-600 transition">Keamanan</a>
                <a href="#" class="text-sm font-medium text-gray-700 hover:text-blue-600 transition">Biaya &amp; Limit</a>
                <a href="#" class="text-sm font-medium text-gray-700 hover:text-blue-600 transition">Tentang Kami</a>
            </div>
            ...
            <div class="flex items-center gap-4 shrink-0">
                ...
                <a href="#" class="text-sm font-medium text-gray-700 hover:text-blue-600 transition">
                    Masuk
                </a>
                ...
                <button type="button" class="w-9 h-9 flex items-center justify-center rounded-full bg-gray-900 text-white hover:bg-gray-800 transition">
